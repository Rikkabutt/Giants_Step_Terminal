...
function selfdestruct( args ) {
    const promptMsg = ["Are you sure you want to proceed with this action?(CURRENTLY NOT WORKING. IF YOU HAVE AN IDEA AS TO WHY NOT PLEASE LET THE CODER KNOW c:) (Y/N)"];
    return { 
